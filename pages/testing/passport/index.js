      ...
      <main className='max-w-7xl mx-auto px-5 py-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {exhibitors.map((exhibitor) => {
            const isVisible = visibleQRCodeId === exhibitor.id;
            ...
            return (
              ...
              >
                ...
                <button
                  type='button'
                  onClick={() =>
                    setVisibleQRCodeId(isVisible ? null : exhibitor.id)
                  }
                  className='mb-4 rounded-lg bg-ap-blue px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-ap-blue/90'
                >
