...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Automotive Packaging Summit | Sponsor Interest</title>
        <meta
          property='og:title'
          content='Automotive Packaging Summit | Sponsor Interest'
        />
      </Head>
      <div className='max-w-7xl mx-auto px-5 xl:px-0 pt-6 pb-10 lg:pt-10 lg:pb-16'>
        <div className='max-w-2xl mx-auto'>
          <div className='bg-white w-full rounded-md py-3 px-2'>
