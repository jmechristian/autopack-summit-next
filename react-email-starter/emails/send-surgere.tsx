...
interface SendSurgereEmailProps {
  data: {
    data: {
      fullname: String;
      email: String;
...
export const SendSurgereEmail = ({ data }: SendSurgereEmailProps) => {
  return (
    <Html>
      <Tailwind>
        <Head />
            ...
            <Section className='my-5'>
              ...
              <Row>
                <Column className='text-center'>
                  <Button
                    href={`https://autopacksummit.com/workshops/surgere/approve?id=${data.data.id}&email=${data.data.email}`}
...
} as SendSurgereEmailProps;

export default SendSurgereEmail;
