...
interface SendClemsonEmailProps {
  data: {
    data: {
      name: String;
      email: String;
...
export const SendClemsonEmail = ({ data }: SendClemsonEmailProps) => {
  return (
    <Html>
      <Tailwind>
        <Head />
            ...
            <Section className='my-5'>
              ...
              <Row>
                <Column className='text-center'>
                  <Button
                    href={`https://autopacksummit.com/tours/clemson/approve?id=${data.data.id}&email=${data.data.email}`}
...
} as SendClemsonEmailProps;

export default SendClemsonEmail;
